...
void qc(const TString fileMC = "/Users/rnepeiv/workLund/PhD_work/run3omega/cascadeAnalysisPostSQM/data/24jul-lhc24b1b/AnalysisResults.root",
        const TString fileData = "/Users/rnepeiv/workLund/PhD_work/run3omega/cascadeAnalysisPostSQM/data/24jul-lhc22o-pass6/AnalysisResults.root",
        const TString outputDir = "/Users/rnepeiv/workLund/PhD_work/run3omega/cascadeAnalysisPostSQM",
        const TString postFix = "29jul")
{
  ...
  hCentFT0M_rec_data->GetYaxis()->SetRange(2 + inel, 3);
  ...
  labelCentr_data.DrawLatexNDC(0.56,0.78,"LHC22o_pass6_small");
  ...
  labelEvSel_data.DrawLatexNDC(0.56,0.78,"LHC22o_pass6_small");
