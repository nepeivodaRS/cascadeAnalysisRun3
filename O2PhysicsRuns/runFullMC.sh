...
#OPTION="-b --aod-file /Users/rnepeiv/workLund/PhD_work/run3omega/cascadeAnalysisPostSQM/data/LHC24b1b-15Jul-raw/AO2D.root"
...
o2-analysis-lf-cascpostprocessing ${OPTION} |
o2-analysis-lf-mc-centrality ${OPTION} |
...
if [ $rc -eq 0 ]; then
  echo "No problems!"
  resultsDir="${PWD}/results/run3_13tev/full/lhc24b1b/$formatted_date"
